...
const ACTION_HANDLERS = {
  [UPDATE_SLOTS_FOR_CLINIC]: (state, action) => ({
    ...state,
    clinic:{
      ...state.clinic,
  ...
  [SET_SEARCH_DATE]: (state, action) => {
    var searchDate = action.payload;
    var isBack = searchDate.isAfter(moment().startOf('day'));
    return ({
      ...state,
      searchCriteria: {
        ...state.searchCriteria,
